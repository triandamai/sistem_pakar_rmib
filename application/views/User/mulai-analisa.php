              ...
              <div class="col-12 stretch-card grid-margin">
                <div class="card card-secondary">
                  <span class="card-body d-lg-flex align-items-center">
                    <p class="mb-lg-0">Silahkan isi data dibawah.</p>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-9 col-form-label">Nama Pekerjaan</label>
                        <div class="col-sm-3">
                          <input type="number" class="form-control" id="exampleInputUsername2" placeholder="0">
                        </div>
                      </div>
